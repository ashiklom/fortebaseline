...
Time series of aggregate variables (GPP, NPP, AGB, Total LAI), with error bars by structure

```{r summary-captions}
summary_ts_cap <- paste(
  "ED2 plot-level predictions by model configuration."
)
...
Big facet plot (exploratory) of LAI by PFT for all model combinations
