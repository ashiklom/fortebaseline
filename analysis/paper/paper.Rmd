...
title: |
  ...
  of community succession in an Upper Midwest temperate forest
author:
...
We look at these variables independently as time series (Figure \@ref(fig:summary-ts-plot)) and as joint predictions in three years (Figure \@ref(fig:pairs-time)).
