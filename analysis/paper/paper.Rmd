...
ED-2.2 has a mortality scheme, and indeed, parameters related to mortality were occasionally among the most important parameters for predictive uncertainty (Figure \@ref(fig:partial-variance-npp)).
...
Future work should evaluate the impacts of prescribed disturbance regimes on multidecadal predictions of ecological dynamics and biogeochemistry.
...
Different parameter combinations led to huge ranges in ensemble predictions of ensemble variables, with NPP and LAI ranging from zero to more than twice the ensemble mean estimates (Figures \@ref(fig:summary-ts-plot)).
Moreover, different parameter combinations produced qualitatively different ecological narratives (Figures \@ref(fig:lai-pft-plot)).
