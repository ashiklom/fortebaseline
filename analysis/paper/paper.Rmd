...
The closed canopy configuration usually had a higher NPP for the same LAI than the finite canopy configuration, especially later into the simulation.
...
However, _which_ PFT was dominant depended strongly on parameter values, and any of the four PFTs became the dominant one in some subset of simulations (Figure S3).
