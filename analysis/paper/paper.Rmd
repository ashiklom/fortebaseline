...
**Ensemble mean trajectory matches traditional understanding of succession**---rapid growth to peak productivity, followed by gradual decline [@odum_1969_strategy_ecosystem_development]---but **happens too quickly** (Figure \@ref(fig:summary-ts-plot));
...
ED2.2 has a mortality scheme, and indeed, parameters related to mortality were often among the top 10 most important parameters for predictive uncertainty (Figure \@ref(fig:partial-variance-npp)).
