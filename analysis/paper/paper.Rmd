...
| Parameter_name          | Description                                          | Unit                          |
|-------------------------|------------------------------------------------------|-------------------------------|
...
| `root_respiration_rate` | Root respiration rate at reference soil temperature  | μmol CO~2~ (kg fine root)^-1^ |
| `root_turnover_rate`    | Rate of fine rootloss                                | year^-1^                      |
...
| `Vcmax`                 | Maximum rate of CO~2~ carboxylation at 15 °C         | μmol m^-2^ s^-1^              |
