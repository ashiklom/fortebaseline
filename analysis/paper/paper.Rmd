...
summary_ts_cap <- paste(
  ...
  "Individual ensemble members are shown as gray lines.",
  "The solid line is a LOESS regression (`ggplot2::stat_smooth`).",
  "Shading represents the middle 80% (10th to 90th percentile) of predictions.",
...
Model projections of gross and net primary productivity, aboveground biomass, and leaf area index varied substantially with both parameter value and model structure (Figure 2).
