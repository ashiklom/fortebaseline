...
We performed this study at the University of Michigan Biological Station (Ameriflux site US-UMd, 45.5625$^{\circ}$, -84.6975$^{\circ}$), located in Northern Lower Michigan, USA.
...
|-----------------------|-------------------------|
| Early hardwood        | _Betula papyrifera_     |
|                       | _Populus grandidentata_ |
|                       | _Populus tremuloides_   |
| Mid hardwood          | _Quercus rubra_         |
|                       | _Acer rubrum_           |
|                       | _Acer pensylvaticum_    |
| Late hardwood         | _Acer saccharum_        |
|                       | _Fagus grandifolia_     |
