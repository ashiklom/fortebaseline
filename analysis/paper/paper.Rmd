...
Third, even where NPP was similar between default and median runs, the underlying forest composition was very different (Figure 5).
...
Net primary productivity (NPP) and total leaf area index (LAI) varied with both parameter value and model structure (Figure 6).
...
The emergent relationship between NPP and LAI was similar across model configurations early in the runs, but became more sensitive to model configuration later into the runs (Figure 7).
...
The large parameter uncertainty in NPP and LAI also extended to species composition (Figure 8).
...
Model structure and parameters interacted to determine the community assembly and dynamics of each simulation, with consequences for overall ecosystem productivity that varied by model structure (Figure 9).
...
The parameters that contributed most to predictive uncertainty in NPP during the "peak" period (1920-1950) ("partial variance") varied with model structure (Figure 10).
