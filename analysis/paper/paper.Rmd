...
abstract: |
  ...
  In this study, we evaluate the relative importance of two sources of model predictive uncertainty -- "structural" (which processes are represented, and the equations used to represent them) and "parameteric" (plant traits and other parameters used in those equations) -- in simulations of multidecadal carbon cycling and forest succession.
  ...
  (2) What are the relative contributions of parameteric uncertainty (data limitation) vs. structural uncertainty (theoretical limitation?)?
  ...
  Parameter uncertainty contributed more than structural uncertainty to overall uncertainty in the simulations, but both the overall level of parameteric uncertainty and the relative importance of different parameters varied with model structure.
